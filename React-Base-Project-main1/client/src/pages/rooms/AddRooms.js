...
function AddRooms() {
    ...
    const handleSubmit = () => {
        if (!data.id || !data.name || !data.price || !data.amenities) {
    ...
    return (
        <>
            ...
            <div className="form-group row">
                <label htmlFor="text2" className="col-4 col-form-label">Available</label>
                <div className="col-8">
            ...
            <div className="form-group row">
                <div className="offset-4 col-8">
                    <button onClick={handleSubmit} className="btn btn-primary">Submit Room Details</button>
                </div>
            </div>
        </>
    );
